        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between gap-10 px-6">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                Facebook: <a target="_blank" href="https://www.facebook.com/profile.php?id=61571632631636" className="underline">GearX</a>
              </li>
              <li>
                Instagram: <a target="_blank" href="https://www.instagram.com/gearx.ai/" className="underline">gearx.ai</a>
              </li>
              <li>
                Twitter: <a target="_blank" href="https://x.com/GearX_ai" className="underline">GearX</a>
              </li>
              <li>
                LinkedIn: <a target="_blank" href="https://www.linkedin.com/in/gearx-ai-6603b6348/" className="underline">GearX</a>
              </li>
            </ul>
          </div>
        </div>
